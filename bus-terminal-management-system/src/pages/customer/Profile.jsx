...
import { FiSave, FiLock, FiMail, FiPhone, FiCalendar } from 'react-icons/fi';
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-1">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-6 grid w-full grid-cols-2 gap-3 border-t border-slate-100 pt-4">
              <div className="rounded-lg bg-slate-50 p-3 text-center">
                <p className="font-display text-lg font-bold text-ink">{formatNumber(user.loyaltyPoints ?? 0)}</p>
                <p className="text-xs text-ink-muted">Loyalty Points</p>
              </div>
              <div className="rounded-lg bg-slate-50 p-3 text-center">
                <p className="font-display text-lg font-bold text-ink">{formatNumber(user.totalBookings ?? 0)}</p>
                <p className="text-xs text-ink-muted">Total Bookings</p>
              </div>
            </div>

            <div className="mt-4 w-full space-y-3 border-t border-slate-100 pt-4 text-left text-sm">
